                                ...
                                <div className="invoice-detail-body">
                                    <div className="invoice-detail-title">
                                        ...
                                        <div className="invoice-title">
                                            <input type="text" className="form-control" placeholder="Invoice Label" defaultValue="Invoice Label" onChange={(e)=>setForm({...form, invoiceLabel: e.target.value})} />
                                        </div>
                                    </div>
                                                ...
                                                <div className="invoice-address-company-fields">
                                                    <div className="form-group row">
                                                        ...
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="company-name" placeholder="Business Name" onChange={(e)=>setForm({...form,fromName: e.target.value})} />
                                                        </div>
                                                    </div>
                                                    <div className="form-group row">
                                                        <label htmlFor="company-email" className="col-sm-3 col-form-label col-form-label-sm">Email</label>
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="company-email" placeholder="name@company.com" onChange={(e)=>setForm({...form,fromEmail: e.target.value})} />
                                                        </div>
                                                    </div>
                                                    <div className="form-group row">
                                                        <label htmlFor="company-address" className="col-sm-3 col-form-label col-form-label-sm">Address</label>
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="company-address" placeholder="XYZ Street" onChange={(e)=>setForm({...form,fromAddress: e.target.value})} />
                                                        </div>
                                                    </div>
                                                    <div className="form-group row">
                                                        <label htmlFor="company-phone" className="col-sm-3 col-form-label col-form-label-sm">Phone</label>
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="company-phone" placeholder="(123) 456 789" onChange={(e)=>setForm({...form,fromPhone: e.target.value})} />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-xl-5 invoice-address-client">
                                                ...
                                                <div className="invoice-address-client-fields">
                                                    <div className="form-group row">
                                                        ...
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="client-name" placeholder="Client Name" onChange={(e)=>setForm({...form,billToName: e.target.value})} />
                                                        </div>
                                                    </div>
                                                    <div className="form-group row">
                                                        <label htmlFor="client-email" className="col-sm-3 col-form-label col-form-label-sm">Email</label>
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="client-email" placeholder="name@company.com" onChange={(e)=>setForm({...form,billToEmail: e.target.value})} />
                                                        </div>
                                                    </div>
                                                    <div className="form-group row">
                                                        <label htmlFor="client-address" className="col-sm-3 col-form-label col-form-label-sm">Address</label>
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="client-address" placeholder="XYZ Street" onChange={(e)=>setForm({...form,billToAddress: e.target.value})} />
                                                        </div>
                                                    </div>
                                                    <div className="form-group row">
                                                        <label htmlFor="client-phone" className="col-sm-3 col-form-label col-form-label-sm">Phone</label>
                                                        <div className="col-sm-9">
                                                            <input type="text" className="form-control form-control-sm" id="client-phone" placeholder="(123) 456 789" onChange={(e)=>setForm({...form,billToPhone: e.target.value})} />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="row justify-content-between">
                                            <div className="col-md-3">
                                                <div className="form-group mb-4">
                                                    ...
                                                    <input type="text" className="form-control form-control-sm" id="number" placeholder="#0001" onChange={(e)=>setForm({...form,invoiceNumber: e.target.value})} />
                                                </div>
                                            </div>
                                            <div className="col-md-3">
                                                <div className="form-group mb-4">
                                                    <label htmlFor="date">Invoice Date</label>
                                                    <input type="text" className="form-control form-control-sm" id="date" placeholder="Add date picker" onChange={(e)=>setForm({...form,invoiceDate: e.target.value})} />
                                                </div>
                                            </div>
                                            <div className="col-md-3">
                                                <div className="form-group mb-4">
                                                    <label htmlFor="due">Due Date</label>
                                                    <input type="text" className="form-control form-control-sm" id="due" placeholder="None" onChange={(e)=>setForm({...form,invoiceDueDate: e.target.value})} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="form-group row invoice-created-by">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <input type="text" className="form-control form-control-sm" id="payment-method-account" placeholder="Bank Account Number" onChange={(e)=>setForm({...form,accountNumber: e.target.value})} />
                                                    </div>
                                                </div>
                                                <div className="form-group row invoice-created-by">
                                                    <label htmlFor="payment-method-bank-name" className="col-sm-3 col-form-label col-form-label-sm">Bank Name:</label>
                                                    <div className="col-sm-9">
                                                        <input type="text" className="form-control form-control-sm" id="payment-method-bank-name" placeholder="Insert Bank Name"onChange={(e)=>setForm({...form,bankName: e.target.value})} />
                                                    </div>
                                                </div>
                                                <div className="form-group row invoice-created-by">
                                                    <label htmlFor="payment-method-code" className="col-sm-3 col-form-label col-form-label-sm">SWIFT code:</label>
                                                    <div className="col-sm-9">
                                                        <input type="text" className="form-control form-control-sm" id="payment-method-code" placeholder="Insert Code" onChange={(e)=>setForm({...form,swiftCode: e.target.value})}/>
                                                    </div>
                                                </div>
                                                <div className="form-group row invoice-created-by">
                                                    <label htmlFor="payment-method-country" className="col-sm-3 col-form-label col-form-label-sm">Country:</label>
                                                    <div className="col-sm-9">
                                                        <select name="country_code" className="form-control country_code  form-control-sm" id="payment-method-country"onChange={(e)=>setForm({...form,country: e.target.value})}>
                                            ...
                                            <div className="col-md-12 align-self-center">
                                                <div className="form-group row invoice-note">
                                                    ...
                                                    <div className="col-sm-12">
                                                        <textarea className="form-control" id="invoice-detail-notes" placeholder="Notes - For example, &quot;Thank you for doing business with us&quot;" style={{ height: 88 }} onChange={(e)=>setForm({...form, note: e.target.value})} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group mb-0 tax-rate-deducted" >
                                                                ...
                                                                <input type="number" className="form-control input-rate" id="rate" placeholder="Rate"  onChange={(e)=>setForm({...form, tax: e.target.value})} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group mb-0 discount-amount" >
                                                                ...
                                                                <input type="number" className="form-control input-rate" id="rate" placeholder="Rate"  onChange={(e)=>setForm({...form, discount: e.target.value})} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="invoice-actions-btn">
                                            <div className="invoice-action-btn">
                                                <div className="row">
                                                    ...
                                                    <div className="col-xl-12 col-md-4">
                                                        <a onClick={()=>setPreview(!Preview)} className="btn btn-dark btn-preview">{Preview ? "Edit" : "Preview"}</a>
                                                    </div>
                                                    <div className="col-xl-12 col-md-4">
